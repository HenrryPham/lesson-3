  ...
  return (
    <div className="products_container">
      {Products.map((product, i) => (
        <Products key={i} Name={product.name} price={product.price} discount={product.discount} 
         chip={product.chip} sizeScreen={product.sizeScreen} ram={product.ram} rom={product.rom}/>
      ))}
    </div>
  );
